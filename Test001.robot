...
${BudgetName}                         Testing_03

#Cost Tracking Contract/Purchase Order Creation
${ContractName}                      ContractStage_01
${PurchaseOrderName}                 PurchaseOrderStage_01

#Cost Tracking Work Order/Change Order Creation
${WorkOrderName}                     WorkOrderStage_01
...
#   Click Element                              link=${BudgetName}
   ...
   Maximize Browser Window
   Sleep                                      3
   Click Element                              //input[contains(text(),'T_')]
#detail
   # T_42334764_1
   # input[id^='T-'][id$=]
